...
const values = [
  {
    ...
    description:
      'Motivation is unreliable. Discipline is a skill. We build systems that keep you moving forward on the days when you don\'t want to.',
  },
  {
    title: 'Data, Not Guesswork',
    description:
      'Every program is calibrated to real metrics — body composition, strength benchmarks, and progress photography. If we can measure it, we can improve it.',
  },
  {
    title: 'Long-Term by Design',
    description:
      'We don\'t chase quick transformations that don\'t last. Our protocols are designed to build a body and a lifestyle that you maintain for decades.',
  },
];
...
const team = [
  {
    ...
    bio: 'CSCS-certified with 12 years coaching elite athletes and everyday people. Competed nationally in powerlifting before founding ASCENDX.',
  },
  {
    name: 'Nadia Chen',
    role: 'Nutrition Director',
    bio: 'Registered dietitian specializing in body composition. Masters in Sports Nutrition from Loughborough University.',
  },
  {
    name: 'Dom Okafor',
    role: 'Conditioning Specialist',
    bio: 'Former professional rugby player. Specializes in metabolic conditioning, movement quality, and athletic performance.',
  },
];
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="px-6 pt-24 pb-20 max-w-7xl mx-auto">
        ...
        <ScrollReveal direction="up" delay={100}>
          ...
          >
            Built on{' '}
            <em className="not-italic text-muted-foreground">discipline.</em>
          </h1>
        </ScrollReveal>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <ScrollReveal direction="left" threshold={0.1}>
            <div className="liquid-glass rounded-2xl border border-border/40 aspect-[4/5] flex items-center justify-center">
              <span
                className="text-[8rem] font-normal text-foreground/5 select-none"
                style={{ fontFamily: "'Instrument Serif', serif" }}
              >
                AX
              </span>
          ...
          {values.map((value, i) => (
            <ScrollReveal key={value.title} direction="up" delay={i * 100} threshold={0.1}>
              <div className="liquid-glass rounded-2xl p-8 border border-border/40">
                <div
                  className="text-3xl font-normal text-foreground mb-3 leading-snug"
                  style={{ fontFamily: "'Instrument Serif', serif" }}
                >
                  {value.title}
                </div>
          ...
          {team.map((member, i) => (
            <ScrollReveal key={member.name} direction="up" delay={i * 120} threshold={0.1}>
              <div className="liquid-glass rounded-2xl p-8 border border-border/40">
                ...
                <div
                  className="text-xs text-muted-foreground tracking-wide uppercase mb-4"
                  style={{ fontFamily: "'Inter', sans-serif" }}
                >
                  {member.role}
                </div>
